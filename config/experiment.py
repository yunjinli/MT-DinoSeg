...
@ExperimentRegistry.register("semseg_bdd100k_r2s100k_mask_only_supervision")
@dataclass
class SemsegBDD100kR2S100kMaskOnlySupervision(Config):
    experiment_name: str = "semseg_bdd100k_r2s100k_mask_only_supervision"
    multidataset: bool = True
    cross_task_supervision: bool = False
    model_name: str = "custom_model"
    model: ModelConfig = field(init=False)
    ...
    def __post_init__(self):
        ...
        self.model.decoder.num_classes = len(manual_labels_dict['sup_names'])
        self.model.decoder.no_object_weight = {'bdd100k': 0.1, 'r2s100k': 0.01, 'pseudo': 0.01}
        self.model.decoder.class_weight = 0.0
